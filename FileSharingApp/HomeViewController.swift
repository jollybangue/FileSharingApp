...
class HomeViewController: UIViewController {
    ...
    private func copyDataFromStorageToRealtimeDB() {
        myStorageRef.child(fileStorageRoot).listAll { [self] result, error in
            ...
            var id = 1000 /// With id = 10, we have ids from 10 to 99; With id = 100, we have ids from 100 to 999; With id = 1000, we have ids from 1000 to 9999.
            for item in fileReferences {
                ...
                /// Writing file names get from Firebase cloud storage into Firebase Realtime database, with ids generated manually. Min: id1000, Max: id9999, Total: 9000 potential ids.
